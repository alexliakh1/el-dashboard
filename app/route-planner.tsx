...
export default function RoutePlanner() {
  ...
  return <main className="dashboard">
    ...
    {settings?<form onSubmit={save}>
      ...
      <label>Display screen<select value={settings.displayMode ?? 'drive'} onChange={e=>update('displayMode',e.target.value as 'drive'|'eta')}><option value="drive">Drive time</option><option value="eta">Arrival time (leave now)</option></select></label>
      <p className="meta">Choose one steady screen. Arrival time is arrival at the destination if you leave now. Parking / walking and the safety buffer still apply to your leave-by recommendation.</p>
