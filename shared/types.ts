export type Settings = {
  ...
  brightness: number; rotateScreens: boolean;
};
...
export type DisplayPayload = {
  ...
  serverEpoch: number; utcOffsetSeconds: number; ageSeconds: number; refreshAfterSeconds: number;
  ...
  display: { brightness: number; rotateScreens: boolean; leaveTime: string; arriveTime: string; changeTime: string };
};
